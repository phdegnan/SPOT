...
$0 -r sgrS.fasta -l sgrS_diff.txt -u 150 -d 100 -c '0.5 0.001 un' -o relaxed -a NC_000913 -g Y \n
Example of running for reanalysis of data with different filters:
$0 -r sgrS.fasta -u 150 -d 100 -o changed_50_30 -a NC_000913 -c '0.5 0.001 un' -g Y -b -50 -e 30 -z Y\n
